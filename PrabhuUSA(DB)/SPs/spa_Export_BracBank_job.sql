DROP PROCEDURE [dbo].[spa_Export_BracBank_job] 
GO
--spa_Export_BracBank_job '20100003','Cash Pay','anoop','30100003','dc','a','BracBank'
CREATE PROCEDURE [dbo].[spa_Export_BracBank_job] 
@agent_id varchar(50),
...
if @ditital_id is null
	...
	SET @job_name = 'spa_Export_BracBank' + @process_id
	SET @spa = 'spa_Export_BracBank  ''' + @agent_id  +''','+
