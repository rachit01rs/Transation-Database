...
/****** Object:  StoredProcedure [dbo].[spa_Export_PNB_job]    Script Date: 11/24/2014 13:15:43 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spa_Export_PNB_job]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spa_Export_PNB_job]
GO
/****** Object:  StoredProcedure [dbo].[spa_Export_PNB_job]    Script Date: 11/24/2014 13:15:43 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[spa_Export_PNB_job]     
...
if @ditital_id is null    
 ...
 SET @job_name = 'spa_Export_PNB' + @process_id    
 SET @spa = 'spa_Export_PNB  '+case when @agent_id is null then 'Null'  ELSE '''' + @agent_id  +'''' END +','+    
