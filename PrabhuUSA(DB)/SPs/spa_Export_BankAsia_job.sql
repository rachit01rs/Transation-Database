IF OBJECT_ID('spa_Export_BankAsia_job','P') IS NOT NULL
	DROP PROCEDURE [dbo].[spa_Export_BankAsia_job]
GO
--spa_Export_JanataBank_job '20100004','Cash Pay','ranesh','30101265',NULL,'a','JBBLCashPay','09/12/2010','09/30/2011'  
CREATE PROCEDURE [dbo].[spa_Export_BankAsia_job]
...
AS 
    ...
    SET @job_name = 'spa_Export_BankAsia' + @process_id  
    SET @spa = 'spa_Export_BankAsia ' 
