DROP procedure [dbo].[spa_search_transaction_v2]    
go 
...
CREATE procedure [dbo].[spa_search_transaction_v2]    
...
set @clm_name='m.tranno,m.refno,m.branch,m.senderCommission,m.sendername,senderphoneno,receivername,receiverphone,rbankid,rbankname,rbankbranch,    
