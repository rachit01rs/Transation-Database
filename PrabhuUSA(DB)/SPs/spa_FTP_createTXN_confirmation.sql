IF OBJECT_ID('spa_FTP_createTXN_confirmation','P') IS NOT NULL
DROP PROC [dbo].[spa_FTP_createTXN_confirmation] 
Go
/*  
** Database    : PrabhuUSA  
...
*/
CREATE PROC [dbo].[spa_FTP_createTXN_confirmation] 
@refno VARCHAR(50),
...
-------------Update the txn in temp table for reference-------------------------------------------	
	 ...
	 WHERE  DataInsertedInMoneySend = 'p'
