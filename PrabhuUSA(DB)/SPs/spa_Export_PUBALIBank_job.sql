IF OBJECT_ID('spa_Export_PUBALIBank_job','P') IS NOT NULL
	DROP PROCEDURE [dbo].[spa_Export_PUBALIBank_job]     
GO
CREATE PROCEDURE [dbo].[spa_Export_PUBALIBank_job]     
@agent_id varchar(50),    
...
if @ditital_id is null    
 ...
 SET @job_name = 'spa_Export_PUBALIBank' + @process_id    
 SET @spa = 'spa_Export_PUBALIBank ''' + @agent_id  +''','+    
